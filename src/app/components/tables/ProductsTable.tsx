                                ...
                                <tbody>
                                    {
                                        productsInCart?.map((cartProduct: any) => <tr key={cartProduct?._id} className="text-center border-b border-opacity-20 border-gray-500 bg-gray-100">
                                            ...
                                            <td className="p-3 hidden md:block">
                                                <Link href={`/food/${cartProduct?.restaurant.toLowerCase()}/${cartProduct?.slug}`}>
                                            ...
                                            <td className="p-3 text-left">
                                                <Link href={`/food/${cartProduct?.restaurant.toLowerCase()}/${cartProduct?.slug}`}>{cartProduct?.name}</Link>
                                            </td>
                                            <td className="p-3">
