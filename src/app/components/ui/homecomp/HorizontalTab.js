    ...
    return (
        <div className='mt-3 md:mt-12 min-h-[350px] relative'>
            <ul className='flex gap-2 items-center justify-between overflow-x-auto'>
                ...
                <li className={`${tabStyle} ${tabQuery === 'newcomers' ? 'text-secondary border-secondary' : 'text-black border-[#d9d9d9]'}`} onClick={() => setTabQuery('newcomers')}><MdFiberNew className='w-5 h-5' />Newcomers</li>
