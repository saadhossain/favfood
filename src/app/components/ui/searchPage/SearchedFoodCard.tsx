    ...
    return (
        <div className='bg-gray-200 p-2 rounded-md md:flex gap-2 items-center'>
            ...
            <div className='w-full md:w-3/4'>
                ...
                <Link href={`/restaurants/${food.restaurant_Name.toLowerCase()}`} className='flex gap-2 items-center font-semibold text-gray-600 hover:text-secondary'><FaShop />{food.restaurant_Name}</Link>
